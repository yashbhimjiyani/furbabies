...
<body style="background-image: url('assets/img/images\ \(1\).jpg');background-position: center;">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (isset($_POST["submit"])) {
            ...
            if (isset($_POST["set_service"]) || !(isset($_POST["set_state"]))) {
                $category = $_POST["set_service"];
                $condition = "`category`='" . $category . "'";
            } else if (isset($_POST["set_state"]) || !(isset($_POST["set_service"]))) {
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse mx-auto" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 mx-auto">
                        ...
                        <li class="nav-item mx-2">
                            <a class="nav-link nav-link-custom" href="home.html#contactsus">Contact Us</a>
                        </li>
    ...
    <main>
        <div class="container fluid mt-2" style="background-color:rgb(195, 248, 188); background-repeat: no-repeat;background-size: cover;background-origin: content-box;">
            <div class="container">
                <div class="row p-4">
                    <h3 style="color: navy;font-weight: bolder;text-align:center;font-size:34px">Available Pet Services... </h3>
                </div>
                <form action="" method="POST">
                    <h3 style="color: navy;font-weight: bolder;padding-top:15px">Filter Category: </h3>
                    <div class="row">
                        <div class="col-3">
                        ...
                        <div class="col-3">
                            <select name="set_city" id="set_city">
                                <option value="Select City/District">City/District</option>
                                <option value=""></option>
                            </select>
                        </div>
                        <div class="col-3">
                            <select name="set_service" id="set_service">
                                <option value="Search by Pet Service" selected disabled>Pet Service</option>
                                <option value="pet_training">pet_training</option>
                        ...
                        <div class="col-1"><input type="submit" value="Apply" name="submit"></div>
                        <div class="col-1"><input type="submit" value="Clear"></div>
                    </div>
                </form>
                <hr style="color:gray;">
                <div class="row text-white m-2">
                    <?php
                    $sql = "SELECT * FROM `services` WHERE " . $condition;
                    ...
                    ?>
                            ...
                            <div class="col-3 card m-2" style="width: 15rem;background: transparent;">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <p class="card-text" style="color: darkslategray;font-weight: bolder;"><?php echo $rows["address"] ?></p>
