...
<body style="background-image: url('assets/img/images\ \(1\).jpg');background-position: center;">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse mx-auto" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 mx-auto">
                        ...
                        <li class="nav-item mx-2">
                            <a class="nav-link nav-link-custom active" href="hospital.php">Hospitals</a>
                        </li>
                        <li class="nav-item mx-2">
    ...
    <main>
        <div class="container fluid mt-2" style="background-color:rgb(195, 248, 188); background-repeat: no-repeat;background-size: cover;background-origin: content-box;">
            <div class="container">
                <div class="row p-4">
                    <h3 style="color: navy;font-weight: bolder;font-size: 34px;text-align:center">Hospitals near you... </h3>
                </div>
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                ...
                <div class="row text-white m-2">
                    <?php
                    try {
                        $sql = "SELECT * FROM `hospitals` WHERE " . $condition;
                        // echo $sql;
                    ...
                    ?>
                            ...
                            ?> <h2 style="color: navy;font-weight:bold;text-align:center;">NO RESULTS</h2>
                    <?php
                        }
                    } catch (Exception $e) {
                        echo $e;
